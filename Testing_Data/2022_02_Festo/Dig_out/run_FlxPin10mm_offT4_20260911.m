%% run_FlxPin10mm_offT4_20260911.m
...
%   minimizeFlxPin10_results_20260911_2brkt_2trans_offT4.mat
% Log: Dig_out\FlxPin10mm_2brk_offT4_20260911.log
...
logfile = fullfile(here, 'FlxPin10mm_2brk_offT4_20260911.log');
diary(logfile); diary on;
fprintf('=== run_FlxPin10mm_offT4 | %s ===\n', string(datetime('now')));
...
saveFile = 'minimizeFlxPin10_results_20260911_2brkt_2trans_offT4.mat';
...
if isempty(saveVars)
    ...
    save('flxpin_offT4_workspace_dump_20260911.mat');
else
