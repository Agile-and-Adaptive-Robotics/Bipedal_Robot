% 1-TRANSFORM (yaw-only) variant, recreated exactly from git commit 3374847 for comparison with the current 2trans method.
% STAGED 2026-09-08 by laptop zcode session (DESKTOP-5Q16KE9): UNTESTED, never executed.
%% Two-bracket flexor evaluator (new method, Sept 2026)
function [f_all, bpa_all] = minimizeFlxPin2brk_1trans(Xi0,Xi1,Xi2,idx_val,useB2)
