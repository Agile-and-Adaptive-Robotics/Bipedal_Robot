...
PL3 = plot(phiD, Bifemsh_Pam_adj2.Torque(:,3),'LineStyle','--','Color',c4,'DisplayName','Length Optimized, 325 kPa'); 
PL4 = plot(phiD, Bifemsh_Pam_adj1.Torque(:,3),'LineStyle','--','Color',c2,'DisplayName','Length Optimized, 1 kPa');
