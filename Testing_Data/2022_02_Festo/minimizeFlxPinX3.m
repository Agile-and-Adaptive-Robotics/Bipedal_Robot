...
function [f_all, bpa_all] = minimizeFlxPinX3(Xi0,Xi1,Xi2,Xi3,idx_val)
...
bpa_i = klass;  % 
kspr = Spr(bpa_i, Xi3); %Calculate spring rate (Infinite if no tendon is used)
...
%% tendon springrate
function springrate = Spr(klass, X3)
    k2 = X3;
    c2 = 1/k2;
    if klass.ten > 0
