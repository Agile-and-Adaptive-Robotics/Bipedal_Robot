...
% 42cm length, no tendon
    load KneeFlxPin_10mm_46cm.mat Vas_Pam_42cm phiD
    ...
    ke(1).L(3) = struct('Ak',phiD,'Loc',Vas_Pam_42cm.Location,'CP',Vas_Pam_42cm.Cross,'dBPA',Vas_Pam_42cm.Diameter, ...
                  ...
                  'Lmt_p',[],'mA_p',[],'M_p',[]);
    clear Vas_Pam_42cm phiD Ma G Angle Torque InflatedLength ICRtoMuscle TorqueHand A

% 42cm length, tendon
    load KneeFlxPin_10mm_46cm.mat Vas_Pam_42cm_ten phiD
    Ma = Vas_Pam_42cm_ten.MomentArm;                 %Calculated moment arm
    G = (Ma(:,1).^2+Ma(:,2).^2).^(1/2);         %Moment arm for z-axis torque
    load Plot_KneeFlxPin_10mm_46cm.mat Angle Torque InflatedLength ICRtoMuscle TorqueHand
    A = sortrows([Angle, Torque, InflatedLength, ICRtoMuscle, TorqueHand]);
    ke(1).L(3) = struct('Ak',phiD,'Loc',Vas_Pam_42cm_ten.Location,'CP',Vas_Pam_42cm_ten.Cross,'dBPA',Vas_Pam_42cm_ten.Diameter, ...
                  'Tk',Vas_Pam_42cm_ten.TransformationMat,'rest',Vas_Pam_42cm_ten.RestingL,'Kmax',Vas_Pam_42cm_ten.Kmax,...
                  'fitn',Vas_Pam_42cm_ten.FittingLength,'ten',Vas_Pam_42cm_ten.TendonL,'P',Vas_Pam_42cm_ten.Pressure, ...
                  'Lmt',Vas_Pam_42cm_ten.MuscleLength,'strain',Vas_Pam_42cm_ten.Contraction, 'unitD',Vas_Pam_42cm_ten.UnitDirection, ...
                  'mA',G,'Fm',Vas_Pam_42cm_ten.Fmax,'F',Vas_Pam_42cm_ten.Force, 'seg',Vas_Pam_42cm_ten.SegmentLengths, ...
                  'M',Vas_Pam_42cm_ten.Torque(:,3),'Aexp',A(:,1),'Mexp',A(:,2),...
                  'A_h',A(:,1),'Lm_h',A(:,3),'mA_h',A(:,4),'M_h',A(:,5),...
                  'Lmt_p',[],'mA_p',[],'M_p',[]);
    clear Vas_Pam_42cm_ten phiD Ma G Angle Torque InflatedLength ICRtoMuscle TorqueHand A
    

% 46cm length
    load KneeFlxPin_10mm_46cm.mat Vas_Pam_46cm phiD
...
if nargout > 1
load KneeFlxPin_10mm_48cm.mat Vas_Pam_48cm phiD
