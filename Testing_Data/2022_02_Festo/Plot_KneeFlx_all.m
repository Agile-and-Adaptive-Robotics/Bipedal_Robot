...
%First Figure
h1 = openfig('Flx10mm_pin_48cm_optimized.fig','reuse'); % open figure
ax1 = gca; % get handle to axes of figure
%Second Figure
h2 = openfig('Flx10mm_pin_46cm_validation.fig','reuse');
ax2 = gca;
%Third Figure
h3 = openfig('Flx10mm_42cm.fig','reuse');
ax3 = gca;

%Fourth Figure
h4 = openfig('Flx20mm_42cm.fig','reuse');
ax4 = gca;
...
xlabel(s3,'\bf \theta_k, \circ')
xlabel(s4,'\bf \theta_k, \circ')
% Create textbox
