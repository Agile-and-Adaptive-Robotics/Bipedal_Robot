...
InflatedLength3 = []/1000;
InflatedLength4 = []/1000;
...
TorqueHand2 = TorqueHand((size(TorqueHand1,2)+size(TorqueHand2,2)+size(TorqueHand3,2)+1):size(TorqueHand,2));
%% Mean and RMSE
...
scatter(Angle1,Torque1,sz,'d','r','DisplayName','JM LC');
scatter(Angle2,Torque2,sz,'d','CData','b','DisplayName','BB LC');
scatter(Angle3,Torque3,sz,'d','g','DisplayName','BB FS');
scatter(Angle4,Torque4,sz,'d','CData',c,'DisplayName','BB FS');
scatter(Angle1,TorqueHand1,sz,'filled','CData','r','DisplayName','JM hand');
scatter(Angle2,TorqueHand2,sz,'filled','CData','b','DisplayName','BB hand');
scatter(Angle3,TorqueHand3,sz,'filled','CData','g','DisplayName','BB hand');
scatter(Angle4,TorqueHand4,sz,'filled','CData',c,'DisplayName','BB hand');
