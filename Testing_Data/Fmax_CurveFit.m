...
A = [845	840	785	780	710	709	571	571	112	415	453	490	518	551	361	54	27	69	275	151	193	10	120	220	260	281	281	83	132	182	233	281	382	426	521;
    0.1716	0.1726	0.1694	0.1705	0.1775	0.1749	0.1839	0.1821	0.1607	0.1663	0.161147903	0.1878	0.1660	0.1742	0.1717	0.1481	0.1481	0.1594	0.1709	0.1523	0.1658	0.1000	0.1667	0.1591	0.1615	0.1637	0.1459	0.1566	0.1591	0.1648	0.1717	0.1744	0.1780	0.1761	0.1612;
447.1	447.1	472.0	472.0	452.3	452.3	461.6	461.6	343.3	457.1	439.6	455.0	493.1	453.1	436.4	238.2	135.3	271.5	412.3	347.2	396.2	8.3	341.27	377.75	383.53	419.44	407.13	317.15	363.61	380.25	394.95	436.00	459.11	455.37	484.23];
...
Zun = [840	0	NaN	114.32	191.8	275.2	355.4	447.1;
    ...
    120	0	11.2	71.6	132.0	194.3	260.6	343.3;
    220	0	19.9	83.8	147.8	217.4	289.2	457.1;
    260	0	30.6	92.7	156.1	225.1	296.1	439.6;
    281	0	54.4	120.7	187.5	258.1	330.3	455.0;
    281	0	37.7	104.7	173.0	244.5	317.6	493.1;
...
Zsrt = sortrows(Zun(1:23,:));           %first column is resting lengths
bpaRestL = Zsrt(:,1);
