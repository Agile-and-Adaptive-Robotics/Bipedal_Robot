...
\include{chapters/10-introduction}
\include{chapters/15-background}
\include{chapters/20-methods}
\include{chapters/30-results}
\include{chapters/40-discussion}
\include{chapters/50-futurework}
\include{chapters/60-conclusion}
\include{chapters/90-bib}

%-------------------------Appendices-----------------------------
\backmatter
\appendix
\include{chapters/92-AppendixA}
\include{chapters/93-AppendixB}
