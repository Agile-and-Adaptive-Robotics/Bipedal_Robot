...
\noindent Publication note: Sections~\ref{sec:disc_effects}--\ref{sec:disc_bio} and the associated figures and tables appeared in \citet{bolen_2026} (Bolen, Elzein, Pang, and Hunt, \emph{Actuators}, 2026). Section~\ref{sec:disc_error} appeared in \citet{bolen_isometric_2025} (Bolen, Burgess, Morrow, Elzein, Pang, Scharzenberger, and Hunt, submitted to \emph{Frontiers in Robotics and AI}). Author contributions for both works are stated in Chapter~\ref{ch:methods}.\par}
