...
\noindent Publication note: Section~\ref{sec:results_force} and the associated figures and tables appeared in \citet{bolen_2026} (Bolen, Elzein, Pang, and Hunt, \emph{Actuators}, 2026). Section~\ref{sec:results_torque} and the associated figures and tables appeared in \citet{bolen_isometric_2025} (Bolen, Burgess, Morrow, Elzein, Pang, Scharzenberger, and Hunt, submitted to \emph{Frontiers in Robotics and AI}). Author contributions for both works are stated in Chapter~\ref{ch:methods}.\par}
