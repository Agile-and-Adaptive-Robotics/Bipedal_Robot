...
$\tau_{\text{acc}}$). Optional calcium channels are defined in the model but
disabled in the current configuration.

\begin{table}[htbp]
\caption{Spiking neuron parameters in the AnimatLab bipedal walker model. All
neurons share these values except the motor neuron threshold noted below.}
...
synapses (rectifying coupling 0.1, non-rectifying 0.2) are also defined and
remain available for the sensory afferent pathways of the MuJoCo/SNS
implementation.
