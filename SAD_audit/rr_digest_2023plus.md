# RR-style digest — recent papers (2023–2026) relevant to SAD — built 2026-09-12
...
deduped against the 483-DOI SAD corpus, preprint/eLife-version twins collapsed, and the
...
| 9 | 10.3389/fncir.2023.1235181 | 2023 | Chacon | Lumbar V3 interneurons provide direct excitatory input | extends the V3 (Zhang 2022) line already in SAD |
...
- Zhang 2022 V3 → already in SAD (batch 2, KIG9DEKJ). ✓ no action
...
- Harrison 2023 podokinetic path integration → judged OUT of SAD scope (attention/path
