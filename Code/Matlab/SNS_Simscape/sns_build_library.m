...
function s = synapseIconCode()
    % E/I marker chosen automatically from the SIGN of Esyn, Animatlab colors:
    %   Esyn <  0 -> inhibitory  -> SOLID BLACK CIRCLE on light-RED backdrop
    %   Esyn >= 0 -> excitatory  -> WHITE TRIANGLE (heavy black edge) on
    %                               light-GREEN backdrop
    %   unknown expression   -> gray backdrop + "E?" text
    % Heavy triangle edge: black triangle under a slightly smaller white one.
    s = strjoin({ ...
        'es_ = NaN;' ...
        'try' ...
        '    tmp_ = Esyn;' ...
        ...
        '    patch([0 -0.92 0.92], [-0.86 0.68 0.68], [0 0 0]);' ...
        '    patch([0 -0.78 0.78], [-0.72 0.56 0.56], [1 1 1]);' ...
        'end' ...
        }, newline);
end
