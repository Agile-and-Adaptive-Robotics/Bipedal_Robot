...
x40_1 = [-0.05 -0.04, -0.03, -.02 0  0.25]';
y40_1 = [2800   1900, 1000,     0 0   0]';   %0 kPa results
x40_2 = [-0.05 -.04  -.03  -0.01   0    0.05 0.17 0.25]';
y40_2 = [4000   3000  2000  1300  1100  500    0     0]';    %100 kPa results
x40_3 = [-0.05 -.03 -.01 0    0.04 0.09 0.25]';
y40_3 = [5000  3200 2500 2100 1500 1000    0]';    %200 kPa results
x40_4 = [-.05 -.03, -.02 0.01  0.06 0.16, .25]';
y40_4 = [6000  4250 3900 2400  2000 1000, 300]';    %300 kPa results
x40_5 = [-.05 -.039 -.01 .005 0.05 0.11 0.20 0.25]';
y40_5 = [6000  6000 4300 4000 3000 2000 1000 600]';    %400 kPa results
x40_6 = [-.05 -.02 .008 0.04 0.09 0.15 0.23 .25]';
y40_6 = [6000 6000 5000 4000 3000 2000 1000 800]';    %500 kPa results
x40_7 = [-.05 .008 0.04 .075 0.12 .175 0.25]';
y40_7 = [6000 6000 5000 4000 3000 2000 1000]';    %620 kPa results
FestoLookup40(1,:) = interp1(x40_1,y40_1,Y1,'linear');
FestoLookup40(2,:) = interp1(x40_2,y40_2,Y1,'linear');
FestoLookup40(3,:) = interp1(x40_3,y40_3,Y1,'linear');
FestoLookup40(4,:) = interp1(x40_4,y40_4,Y1,'linear');
FestoLookup40(5,:) = interp1(x40_5,y40_5,Y1,'linear');
FestoLookup40(6,:) = interp1(x40_6,y40_6,Y1,'linear');
FestoLookup40(7,:) = interp1(x40_7,y40_7,Y1,'linear');
...
FestoLookup20(1,:) = interp1(x20_1,y20_1,Y2,'linear');
FestoLookup20(2,:) = interp1(x20_2,y20_2,Y2,'linear');
FestoLookup20(3,:) = interp1(x20_3,y20_3,Y2,'linear');
FestoLookup20(4,:) = interp1(x20_4,y20_4,Y2,'linear');
FestoLookup20(5,:) = interp1(x20_5,y20_5,Y2,'linear');
FestoLookup20(6,:) = interp1(x20_6,y20_6,Y2,'linear');
FestoLookup20(7,:) = interp1(x20_7,y20_7,Y2,'linear');
