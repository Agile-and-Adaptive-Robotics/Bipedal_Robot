...
fprintf('[%.6f, %.6f, %.6f]\n', predBest.pWrap)
fprintf('wrap z fraction between p1 and pEnd = %.6f\n', ctx.wrapZFraction)
fprintf('wrap release found                  = %d\n', ...
    predBest.routeInfo.releaseFound)
if predBest.routeInfo.releaseFound
    fprintf('interpolated wrap release angle     = %+.6f deg\n', ...
        predBest.routeInfo.releaseAngleD)
else
    fprintf('interpolated wrap release angle     = NONE IN MODELED RANGE\n')
end
