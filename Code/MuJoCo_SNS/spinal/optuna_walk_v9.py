"""v6 study (ground_walk_v9_flat): v5 + swing-knee quad suppression.
...
gain at 0). Writes best_walk_params_v9.json (runner --best6 loads it) and
...
STUDY = "ground_walk_v9_flat"
CSV = HERE / "v9_results.csv"
BEST6 = HERE / "best_walk_params_v9.json"
...
def full22_capture(study: optuna.Study, trial_no: int, p: dict):
    ...
    npz = HERE / f"v9_best_trial{trial_no}.npz"
...
def main(argv):
    ...
    print("saved best_walk_params_v9.json (runner --best9 reproduces)",
          flush=True)
