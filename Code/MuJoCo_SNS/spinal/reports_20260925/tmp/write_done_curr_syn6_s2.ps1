...
# Writes the curr_syn6_s2 done-marker AFTER the python process has exited.
# First line = exit code; then the last 3 lines of the run log.
$log  = "D:\Github\Bipedal_Robot\Code\MuJoCo_SNS\spinal\reports_20260925\logs\curr_syn6_s2.log"
$done = "D:\Github\Bipedal_Robot\Code\MuJoCo_SNS\spinal\reports_20260925\logs\curr_syn6_s2.done"
$tail = @()
try {
